 ...
 * @return Nothing.
 */
export function assertUnsignedInt(
    value: number | null | undefined,
    path: string,
): void {
    if (value === undefined || value === null) return;
 ...
 * @return Nothing.
 */
export function assertLocalDateTime(
    value: string | undefined,
    path: string,
): void {
 ...
 * @return Nothing.
 */
export function assertUtcDateTime(
    value: string | undefined,
    path: string,
): void {
 ...
 * @return Nothing.
 */
export function assertDurationLike(
    value: string | undefined,
    path: string,
    signed: boolean,
): void {
 ...
 * @return Nothing.
 */
export function assertSignedDuration(
    value: string | undefined,
    path: string,
): void {
 ...
 * @return Nothing.
 */
export function assertBooleanMap(
 ...
 * @return Nothing.
 */
export function assertIdBooleanMap(
    value: object | undefined,
    path: string,
): void {
    if (value === undefined) return;
 ...
 * @return Nothing.
 */
export function assertTextContentType(
    value: string | undefined,
    path: string,
): void {
    if (value === undefined) return;
