 ...
 */
export function matchesByMonthDay(date: DateCandidate, byMonthDay: number[]): boolean {
 ...
 */
export function matchesByYearDay(date: DateCandidate, byYearDay: number[]): boolean {
 ...
 */
export function matchesByWeekNo(date: DateCandidate, byWeekNo: number[], firstDay: DayOfWeek): boolean {
