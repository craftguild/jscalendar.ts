...
export type CreateInput<TType extends CalendarType> =
  TType extends "Event"
    ? Omit<Event, "@type" | "uid" | "updated"> & { type?: "Event" | "event"; "@type"?: "Event"; uid?: string; updated?: UTCDateTime }
    : TType extends "Task"
      ? Omit<Task, "@type" | "uid" | "updated"> & { type?: "Task" | "task"; "@type"?: "Task"; uid?: string; updated?: UTCDateTime }
      : Omit<Group, "@type" | "uid" | "updated"> & { type?: "Group" | "group"; "@type"?: "Group"; uid?: string; updated?: UTCDateTime };
